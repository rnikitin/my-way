...
name: filesystem
type: mcp
archetypes: [research-ml, trading-data, docs-pm]
status_by_archetype:
...
**When to use.** Use for file-heavy work: source inspection, local artifacts, markdown memory, experiment reports, and repo maps.
